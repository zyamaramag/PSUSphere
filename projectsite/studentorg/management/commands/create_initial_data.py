...
class Command(BaseCommand):
    ...
    def create_organization(self, count):
        ...
        self.stdout.write(
            self.style.SUCCESS("Initial data for organization created successfully.")
        )
    ...
    def create_students(self, count):
        ...
        self.stdout.write(
            self.style.SUCCESS("Initial data for students created successfully.")
        )
    ...
    def create_membership(self, count):
        ...
        self.stdout.write(
            self.style.SUCCESS("Initial data for student organization created successfully.")
        )
